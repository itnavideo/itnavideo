...
export default function InteractiveRenderEngine({
  ...
  const autoGeneratedDesc = `${displayTitle} 🚀 Created automatically with ItnaVideo AI Studio.\n\n#viral #reels #contentcreator #ai #itnavideo #videoeditor`;
      ...
      <div className="flex items-center justify-between border-b border-zinc-800/80 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400">Simple &amp; Fast HD Video Export Engine</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-5 space-y-5">
          ...
          {isReady && status.outputFile && (
            ...
            >
              <Download size={18} />
              <span>Download Ready HD Video (MP4)</span>
            </a>
          )}
        </div>
