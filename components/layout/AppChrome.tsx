...
function StickyMobileCTA() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 block border-t border-white/10 bg-zinc-950/95 px-4 py-3 backdrop-blur-lg sm:hidden">
      <Link
        href="/signup"
        className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-amber-400 to-amber-500 px-6 py-3.5 text-sm font-black text-slate-950 shadow-[0_0_24px_rgba(245,197,66,0.25)] transition active:scale-[0.97]"
      >
        Get Started Free
      </Link>
    </div>
