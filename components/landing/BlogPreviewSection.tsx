      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-12 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          <div className="max-w-3xl">
            <p className="mb-4 text-sm font-bold uppercase tracking-[0.24em] text-brand-mint">Creator guides</p>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {posts.map((post) => (
            ...
            >
              ...
              <div className="mt-6 inline-flex items-center gap-2 text-sm font-black text-brand-mint">
                Read guide
