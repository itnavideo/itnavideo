      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl font-extrabold text-slate-900 sm:text-5xl font-sans tracking-tight">
            AI Video Generation Features You Can See &amp; Control
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-6 shadow-xs space-y-4">
            ...
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-3">
              ...
              <div className="grid grid-cols-4 gap-1.5">
                <div className="p-2 rounded bg-blue-100 border border-blue-300 text-[10px] font-bold text-blue-800">
                  Scene 1: Hook
                  <span className="block text-[9px] font-normal text-slate-500">0.0s – 7.5s</span>
                </div>
                <div className="p-2 rounded bg-cyan-100 border border-cyan-300 text-[10px] font-bold text-cyan-800">
                  Scene 2: Explain
          ...
          <div className="flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-6 shadow-xs space-y-4">
            ...
            <div className="bg-slate-50 p-6 rounded-xl border border-slate-200 text-center space-y-3">
              <div className="flex items-center justify-center gap-2 flex-wrap">
                ...
                <span className="text-sm font-extrabold text-white bg-blue-600 px-2.5 py-1 rounded shadow-xs">script</span>
                <span className="text-sm font-bold text-slate-500">into</span>
                <span className="text-sm font-extrabold text-blue-600">polished</span>
          ...
          <div className="flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-6 shadow-xs space-y-4">
            ...
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-3">
              ...
              <div className="p-2 rounded bg-white text-center text-xs font-mono text-blue-600 font-bold border border-slate-200">
