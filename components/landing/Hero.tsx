...
const HERO_MOCK_TYPES = [
  {
    ...
    label: 'Auto Caption',
    icon: Captions,
    sample: 'https://res.cloudinary.com/dhouh9idx/video/upload/q_auto,f_auto/v1783942630/Ask_yourself_this_question.Are_you_regretting_your_mistakes..._or_learning_from_them_%EF%B8%8F_d9ekcx.mp4',
    poster: 'https://res.cloudinary.com/dhouh9idx/video/upload/so_1,w_600,q_auto,f_jpg/v1783942630/Ask_yourself_this_question.Are_you_regretting_your_mistakes..._or_learning_from_them_%EF%B8%8F_d9ekcx.jpg',
  },
  {
    id: 'compare-explainer',
    label: 'Compare Explainer',
    icon: Layers3,
    sample: 'https://res.cloudinary.com/dhouh9idx/video/upload/q_auto,f_auto/v1783942288/What_s_the_difference._IIT_vs_ITI_JEE_vs_NEET__Kya_aapko_bhi_in_terms_ke_beech_ka_asli_farq_pa_bflieg.mp4',
    poster: 'https://res.cloudinary.com/dhouh9idx/video/upload/so_1,w_600,q_auto,f_jpg/v1783942289/Whats_the_difference_coupon_voucher_difference_englishtips_englishlesson_qw4kve.jpg',
  },
  {
    id: 'whiteboard-video',
    label: 'Whiteboard',
    icon: PenTool,
    sample: 'https://res.cloudinary.com/dhouh9idx/video/upload/q_auto,f_auto/v1783942287/Indian_Government_Departments_Explained_in_Simple_Words....._indiafacts_education_viralree_hciuyx.mp4',
    poster: 'https://res.cloudinary.com/dhouh9idx/video/upload/so_1,w_600,q_auto,f_jpg/v1783942287/Indian_Government_Departments_Explained_in_Simple_Words....._indiafacts_education_viralree_hciuyx.jpg',
  },
  {
    id: 'typography-video',
    label: 'Typography',
    icon: FileText,
    sample: 'https://res.cloudinary.com/dhouh9idx/video/upload/q_auto,f_auto/v1783942704/Walking_into_new_territory_is_all_about_asking_the_right_questions_And_of_course_collaborating_dxwggb.mp4',
    poster: 'https://res.cloudinary.com/dhouh9idx/video/upload/so_1,w_600,q_auto,f_jpg/v1783942704/Walking_into_new_territory_is_all_about_asking_the_right_questions_And_of_course_collaborating_dxwggb.jpg',
  },
  {
    id: 'long-video-promo',
    label: 'Long Promo',
    icon: Film,
    sample: 'https://res.cloudinary.com/dhouh9idx/video/upload/q_auto,f_auto/v1788190064/file_0000000028e482119337580fc1f3647f_s22zcw.mp4',
    poster: 'https://res.cloudinary.com/dhouh9idx/image/upload/v1788190064/file_0000000028e482119337580fc1f3647f_s22zcw.png',
  },
];
