    ...
    <section className="relative px-4 py-12 sm:px-6 bg-slate-50 border-b border-slate-200 flex justify-center">
      <div className="w-full max-w-4xl">
        ...
        <Link href="/dashboard" className="block group">
          <div className="relative rounded-3xl border-2 border-dashed border-slate-300 bg-white p-6 sm:p-14 text-center transition-all duration-300 group-hover:border-blue-400 group-hover:bg-blue-50/40 group-hover:shadow-lg cursor-pointer">
            
            <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-blue-50 transition-transform duration-300 group-hover:scale-110 group-hover:bg-blue-100 shadow-sm border border-blue-100">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              <span className="flex items-center gap-1.5 text-[11px] font-bold text-slate-600 bg-slate-100 border border-slate-200 px-3 py-1.5 rounded-lg group-hover:bg-white transition-colors">
                <Video size={14} className="text-blue-500" /> MP4, MOV
              </span>
              <span className="flex items-center gap-1.5 text-[11px] font-bold text-slate-600 bg-slate-100 border border-slate-200 px-3 py-1.5 rounded-lg group-hover:bg-white transition-colors">
                <Mic size={14} className="text-amber-500" /> MP3, WAV
              </span>
              <span className="flex items-center gap-1.5 text-[11px] font-bold text-slate-600 bg-slate-100 border border-slate-200 px-3 py-1.5 rounded-lg group-hover:bg-white transition-colors">
            ...
            <div className="mt-8">
              <span className="inline-flex items-center justify-center rounded-full bg-blue-600 px-8 py-3 text-sm font-bold text-white shadow-md transition-all group-hover:bg-blue-700 group-hover:shadow-lg group-active:scale-95">
                Browse Files
              </span>
            </div>
          </div>
