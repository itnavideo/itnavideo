...
export const TYPOGRAPHY_STYLES: TypographyStyle[] = [
  ...
  },
  {
    id: 'm3-assist-chip',
    name: 'M3 Assist Chip',
    tag: 'Google M3 · Assist & Filter',
    category: 'kinetic',
    description: 'Emerald container badges, interactive chip triggers, and punchy kinetic motion',
    videoSrc: getCloudinaryVideoUrl('https://res.cloudinary.com/dhouh9idx/video/upload/v1783945650/professional-creator-after.mp4'),
    posterSrc: getCloudinaryPosterUrl('https://res.cloudinary.com/dhouh9idx/video/upload/v1783945650/professional-creator-after.mp4'),
    accentColor: '#10B981',
    tags: ['Google M3', 'Assist Chip', 'Emerald Tonal', 'Filter Token'],
  },
  {
    id: 'm3-floating-dock',
    name: 'M3 Floating Dock',
    tag: 'Google M3 · Elevated Surface',
    category: 'kinetic',
    description: 'Surface Level 3 tonal cards, violet glow rim lighting, and Display Hero typography',
    videoSrc: getCloudinaryVideoUrl('https://res.cloudinary.com/dhouh9idx/video/upload/v1783945650/professional-creator-after.mp4'),
    posterSrc: getCloudinaryPosterUrl('https://res.cloudinary.com/dhouh9idx/video/upload/v1783945650/professional-creator-after.mp4'),
    accentColor: '#A855F7',
    tags: ['Google M3', 'Floating Dock', 'Surface Level 3', 'Amethyst Glow'],
  },
  {
    id: 'dynamic-punch',
    name: 'Dynamic Punch',
