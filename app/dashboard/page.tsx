...
const modeConfig = {
  ...
  imageStoryCollage: {
    ...
    title: "Cinematic Collage",
    description: "Upload audio/video with speech. AI creates cinematic text scenes synced to your voice. No images needed — AI generates visual scenes.",
    accept: "audio/*,video/*",
    supported: "Supported: MP3, WAV, MP4, MOV, WEBM",
    bestResult: "Best result: clear voiceover explaining a topic, 30-60 seconds.",
    uploadCta: "Choose audio/video with speech",
    icon: Film,
