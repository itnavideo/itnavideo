...
const modeConfig = {
  ...
  imageStoryCollage: {
    ...
    title: "Cinematic Collage",
    description: "Upload audio/video narration + images. AI creates cinematic scenes with Ken Burns motion and text overlays.",
    accept: "audio/*,video/*,image/*",
    supported: "Supported: MP3, WAV, MP4, MOV, WEBM, PNG, JPG",
    bestResult: "Best result: voiceover audio + 3-5 images, or video with clear speech.",
    uploadCta: "Choose audio/video/images",
    icon: Film,
