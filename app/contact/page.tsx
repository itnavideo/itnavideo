...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-[#08070B] text-white selection:bg-orange-500/30 selection:text-orange-200 pt-24 pb-20 px-4 sm:px-6">
      ...
      <div className="relative mx-auto max-w-3xl">
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-3.5" aria-label="Direct contact options">
          <a
            ...
            className="group flex items-center gap-3.5 rounded-2xl border border-white/10 bg-[#131218] p-4 transition-all duration-200 hover:border-orange-500/40 hover:bg-[#162032] shadow-lg"
          >
        ...
        <div className="mt-6 rounded-3xl border border-white/10 bg-[#131218] p-6 sm:p-8 shadow-2xl backdrop-blur-2xl">
