...
export const metadata: Metadata = {
  title: "Dynamic Creator Reel — AI-Edited Talking Videos | Itnavideo",
  description: "Upload your talking video. AI adds dynamic typography, b-roll cuts, and professional editing automatically. Premium creator-style reels in minutes.",
  openGraph: {
    title: "Dynamic Creator Reel — AI-Edited Talking Videos | Itnavideo",
    description: "Upload your talking video. AI adds dynamic typography, b-roll cuts, and professional editing automatically. Premium creator-style reels in minutes.",
    images: ["/og-image.png"],
...
const jsonLd = {
  ...
  name: "Dynamic Creator Reel — Itnavideo",
  applicationCategory: "VideoEditor",
  operatingSystem: "Web",
  url: "https://www.itnavideo.com/video-types/dynamic-creator-reel",
  description: "Upload your talking video. AI adds dynamic typography, b-roll cuts, and professional editing automatically. Premium creator-style reels in minutes.",
  offers: {
    "@type": "Offer",
    priceCurrency: "USD",
...
export default function DynamicCreatorReelPage() {
  return (
    <main className="min-h-screen text-white" style={{ background: '#0F172A' }}>
      ...
      <section className="px-4 pb-16 pt-28 sm:px-6 sm:pt-32">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed sm:text-lg" style={{ color: 'var(--text-dark-secondary)' }}>
            Your talking video, AI-edited with cuts, text, and style.
          </p>
        </div>
      </section>
      ...
      <section className="px-4 pb-16 sm:px-6">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              "AI-powered jump cuts and pacing",
              "Dynamic typography overlays",
              "B-roll style transitions",
              "Professional creator editing feel",
            ].map((item) => (
      ...
      <section className="px-4 pb-16 sm:px-6">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              "Content creators who film talking-head videos",
              "Founders sharing startup updates",
              "Coaches delivering quick tips and lessons",
            ].map((item) => (
      ...
      <section className="px-4 pb-16 sm:px-6">
        <div className="mx-auto max-w-md text-center">
          <Link
            href="/dashboard?videoType=dynamic-creator-reel"
