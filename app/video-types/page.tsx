...
const ALL_VIDEO_TYPES: VideoTypeItem[] = [
  ...
  },
  {
    ...
    desc: "Full 16:9 landscape format subtitles for podcasts, webinars, and YouTube tutorials up to 10 minutes.",
    aspectRatio: "16:9",
    input: "Horizontal Video (MP4/MOV)",
    output: "16:9 Subtitled Landscape Video",
    renderTime: "~45s",
    credits: 3,
    category: "longform",
    image: "/visuals/previews/long-caption-pro.png",
    href: "/long-caption-pro",
    dashHref: "/dashboard?videoType=long-caption-pro",
    tags: ["landscape", "16:9", "youtube", "podcast", "longform"],
    proof: "16:9 Full HD",
    accent: "#22D3EE",
    workflowSteps: [
      "Upload 16:9 landscape video (up to 10 min)",
      "Groq Whisper generates timed landscape captions",
      "Exports broadcast-ready 16:9 video",
    ],
  },
  {
    id: "long-video-clips",
  ...
  },
  {
    ...
    desc: "Turn voiceovers, videos, or scripts into complete 16:9 widescreen YouTube & 9:16 vertical videos with automated B-Roll, ducked music, motion graphics & captions.",
    aspectRatio: "16:9",
    input: "Voiceover / Video / Script",
    output: "16:9 / 9:16 Full Video",
    renderTime: "~50s",
    credits: 3,
    category: "longform",
