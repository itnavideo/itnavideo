...
const jsonLd = {
  ...
  operatingSystem: "Web",
  url: "https://www.itnavideo.com/templates/compare-explainer",
  description: "Create comparison reels with left vs right panels, voiceover subtitles, and sticker presenters. Perfect for education, finance, and career explainers.",
  offers: {
    "@type": "Offer",
    priceCurrency: "USD",
    ...
    <main className="min-h-screen text-white" style={{ background: '#0F172A' }}>
      ...
      <section className="px-4 pb-16 pt-28 sm:px-6 sm:pt-32">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed sm:text-lg" style={{ color: 'var(--text-dark-secondary)' }}>
            Audio + 2 images. AI builds a left-vs-right comparison reel.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              "Voiceover-synced subtitles",
              "Title and handle overlay",
            ].map((item) => (
      ...
      <section className="px-4 pb-16 sm:px-6">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              "Finance educators comparing investment options",
              "Career coaches comparing job paths",
              "Tech reviewers comparing tools or frameworks",
            ].map((item) => (
      ...
      <section className="px-4 pb-16 sm:px-6">
        <div className="mx-auto max-w-md text-center">
          <Link
            href="/dashboard?template=compare-explainer"
