            ...
            <div className="rounded-lg border border-red-400/20 bg-red-500/10 p-4 text-sm leading-6 text-red-100">
              ...
              {showResetHelp && (
                <button
                  ...
                  className="mt-3 font-bold text-emerald-300 transition hover:text-blue-200 disabled:opacity-60"
                >
              ...
              {isUnconfirmedEmailMessage(authError) && (
                <button
                  ...
                  className="mt-3 block font-bold text-emerald-300 transition hover:text-blue-200 disabled:opacity-60"
                >
