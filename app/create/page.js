...
export const metadata = {
  title: "Create 1080p Video | Itnavideo",
    ...
    <main className="brand-surface min-h-screen px-6 py-24 text-white">
      <div className="mx-auto max-w-5xl">
        <div className="mb-10 max-w-3xl">
          ...
          <h1 className="text-5xl font-black leading-tight md:text-6xl">Create a 1080p short from audio or camera video.</h1>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-4">
          ...
          <Feature icon={Video} title="1080p MP4" body="Portrait output for Reels, Shorts, and TikTok." />
        </div>
      </div>
    </main>
  );
