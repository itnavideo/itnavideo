    ...
    const inputProps: Record<string, unknown> = {
      ...
      ...(mode === 'compare'
        ? {
            ...
            stickerStyle: ['2d', 'cartoon', 'explainer', 'girl-teacher', 'girl-teacher-3d', 'grandpa-teacher-3d', 'young-presenter-3d', 'teacher-2d-pro', 'chibi-boy-3d', 'corporate-woman-3d', 'indian-teacher-woman', 'doctor-3d-half'].includes(readString(body.stickerStyle)) ? readString(body.stickerStyle) : 'explainer',
