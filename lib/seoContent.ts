...
export const toolSeoPages: SeoContentPage[] = [
  page({
    ...
    title: "Image to Video AI – 16:9 Widescreen Video Generator | Itnavideo",
    description: "Upload voiceover audio and photos. AI automatically segments scenes, adds Ken Burns pan & zoom, 2.5D parallax subtitles, and BGM ducking.",
    h1: "Image to Video AI for cinematic 16:9 widescreen videos",
    eyebrow: "Image to Video AI",
    hero: "Upload voiceover narration and any number of images. AI synchronizes scenes per line, adds continuous Ken Burns motion, 2.5D parallax subtitles, and cinematic transitions.",
    shortExplanation: "Transform raw audio narration and still images into high-production 16:9 widescreen videos at 30 FPS. Up to 10 minutes of video with automated scene cutting and curated visual fallbacks.",
    primaryKeyword: "image to video ai",
    relatedKeywords: ["image to video generator", "ken burns video maker", "voiceover to video ai", "photo to video maker", "ai video generator"],
    dashboardType: "image-to-video-ai",
    previewImage: "https://res.cloudinary.com/dhouh9idx/image/upload/v1788780290/ChatGPT_Image_Sep_7_2026_04_53_09_PM_suv9x7.png",
    howItWorks: [
      "Upload your voiceover recording up to 10 minutes long.",
      "Optionally upload any number of images or let AI use curated 16:9 visuals.",
      "Configure camera motion (Ken Burns pan/zoom) and 2.5D parallax subtitle styles.",
      "Render a complete 16:9 widescreen MP4 at 30 frames per second.",
    ],
    benefits: [
      "No image limit — upload 5, 20, or 50 images, or none at all.",
      "Automatic sentence-by-sentence scene detection from Groq Whisper audio transcript.",
      "Smooth Ken Burns camera movement (1.0x to 1.18x continuous pan & zoom).",
      "Dynamic background music auto-ducking behind speech.",
    ],
    useCases: [
      "YouTube educational & explainer videos",
      "Documentaries and biographical stories",
      "Product walkthroughs and case studies",
      "Audiobook chapters & podcast visualizers",
    ],
    whyItnavideo: commonWhy,
    faqs: [
      {
        question: "How many images can I upload in Image to Video AI?",
        answer: "There is no fixed limit. You can upload as many images as you need. If you do not upload any images, the system automatically selects curated 16:9 visuals from Itnavideo.",
      },
      {
        question: "What is the maximum duration and frame rate?",
        answer: "Image to Video AI supports up to 10 minutes per video rendered at a smooth 30 FPS in 16:9 (1920x1080) widescreen resolution.",
      },
      {
        question: "How are credits calculated for Image to Video AI?",
        answer: "Image to Video AI costs 2 credits per 1 minute of generated video.",
      },
    ],
    internalLinks: [
      toolLink("faceless-video-generator", "Faceless Video Generator"),
      toolLink("ai-audio-cleaner", "AI Audio Cleaner"),
    ],
  }),
  page({
    kind: "tool",
