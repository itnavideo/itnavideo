...
import bpM3AssistChip from './blueprints/m3-assist-chip.json';
import bpM3FloatingDock from './blueprints/m3-floating-dock.json';
...
export const ADVANCED_STYLE_BLUEPRINTS: Record<string, AdvancedStyleBlueprint> = {
  ...
  'm3-assist-chip': bpM3AssistChip as unknown as AdvancedStyleBlueprint,
  'm3-floating-dock': bpM3FloatingDock as unknown as AdvancedStyleBlueprint,
};
...
export const STYLE_BLUEPRINTS: Record<string, StyleBlueprint> = {
  ...
  'm3-assist-chip': {
    ...
    maxWordsPerChunk: 3,
    kenBurnsIntensity: 0.04,
    colorGrade: { name: 'M3 Emerald Glow', filter: 'contrast(1.15) saturate(1.25)' },
    animationPreset: 'pop',
    animation: {
      mass: 0.52,
      damping: 13,
  ...
  'm3-floating-dock': {
    ...
    maxWordsPerChunk: 3,
    kenBurnsIntensity: 0.04,
    colorGrade: { name: 'M3 Amethyst Glow', filter: 'contrast(1.18) saturate(1.2)' },
    animationPreset: 'pop',
    animation: {
      mass: 0.55,
      damping: 14,
