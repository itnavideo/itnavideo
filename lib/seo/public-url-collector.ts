...
export async function getPublicSitemapUrls(): Promise<PublicSitemapUrl[]> {
  ...
  const staticRoutes: PublicSitemapUrl[] = [
    ...
    {
      path: "/tools/ai-audio-cleaner",
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.92,
    },
    {
      path: "/video-types/ai-video-generator",
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.88,
    },
    {
      path: "/video-types/auto-caption-generator",
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.88,
    },
    ...
    {
      path: "/video-types/caption-studio",
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.88,
    },
    ...
    {
      path: "/video-types/faceless-video",
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.88,
    },
    {
      path: "/video-types/long-caption-pro",
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.88,
    },
    {
      path: "/video-types/long-video-clips",
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.88,
    },
    {
      path: "/video-types/long-video-pro",
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.88,
    },
    ...
    {
      path: "/video-types/typography-video",
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.88,
    },
    {
      path: "/video-types/whiteboard-video",
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.88,
    },
