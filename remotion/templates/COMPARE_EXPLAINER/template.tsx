...
const StickerPresenter = ({
  ...
  const selectedStickerStyle =
    stickerStyle === '2d' ? '2d' : stickerStyle === 'cartoon' ? 'cartoon' : stickerStyle === 'girl-teacher' ? 'girl-teacher' : stickerStyle === 'girl-teacher-3d' ? 'girl-teacher-3d' : stickerStyle === 'grandpa-teacher-3d' ? 'grandpa-teacher-3d' : stickerStyle === 'young-presenter-3d' ? 'young-presenter-3d' : stickerStyle === 'teacher-2d-pro' ? 'teacher-2d-pro' : stickerStyle === 'chibi-boy-3d' ? 'chibi-boy-3d' : 'explainer';
