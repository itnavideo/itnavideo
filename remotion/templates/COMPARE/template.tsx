...
export const TEMPLATE_NAME = 'COMPARE';
export const COMPOSITION_ID = 'COMPARE';
...
.compare-root {
  background: #f7f8f5;
  color: #050505;
  font-family: COMPARE_Inter, Arial, sans-serif;
}
.scene {
  position: absolute;
...
.label {
  ...
  font-family: COMPARE_Bebas, COMPARE_Inter, Arial, sans-serif;
  font-size: 56px;
  line-height: 0.9;
  letter-spacing: 0;
  text-align: center;
...
export const CompareComposition = () => (
  <Composition
    id={COMPOSITION_ID}
    component={Compare}
    fps={fps}
