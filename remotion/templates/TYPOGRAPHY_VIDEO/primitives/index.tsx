...
import { M3AssistChipPrimitive } from './M3AssistChipPrimitive';
import { M3FloatingDockPrimitive } from './M3FloatingDockPrimitive';
...
export function TypographyStyleRenderer({
  ...
  switch (blueprint.id) {
    ...
    case 'm3-assist-chip':
      return <M3AssistChipPrimitive phrase={phrase} localFrame={localFrame} fps={fps} blueprint={blueprint} />;
    case 'm3-floating-dock':
      return <M3FloatingDockPrimitive phrase={phrase} localFrame={localFrame} fps={fps} blueprint={blueprint} />;
    default:
      return <DynamicPunchPrimitive phrase={phrase} localFrame={localFrame} fps={fps} blueprint={blueprint} />;
  }
}
